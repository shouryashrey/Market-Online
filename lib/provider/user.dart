...
import 'package:market_online/models/order.dart';
import 'package:market_online/models/product.dart';
import 'package:market_online/models/user.dart';
import 'package:market_online/services/order.dart';
import 'package:market_online/services/users.dart';
...
//  getter
  ...
  UserProvider.initialize() : _auth = FirebaseAuth.instance {
    ...
    _auth.authStateChanges().listen((event) {_onStateChanged(user);});
  }
